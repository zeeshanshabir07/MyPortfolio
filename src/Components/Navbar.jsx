...
<div className="flex items-center space-x-4 lg:hidden">
  ...
  {/* Menu Button */}
  <button onClick={() => setIsOpen(!isOpen)} className="p-2 text-white rounded-md hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors duration-300">
  ...
  {isOpen && (
    <div className="w-[150px] absolute top-16 right-8 bg-gray-800 dark:bg-gray-900 rounded-lg shadow-lg p-4 space-y-2">
      {['Home', 'About', 'Skills', 'Experience', 'Projects', 'Education', 'Contact'].map((item, idx) => (
        <a
          key={idx}
          href={`#${item.toLowerCase()}`}
